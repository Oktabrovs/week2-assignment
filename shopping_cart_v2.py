...
print(f'3. Large order discount eligibility: {l_o_d}   Amount: {large_order_dis:.2f}')
...
is_saved = subtotal_before_discounts > final
print(f"Total amount saved: {(is_saved*(subtotal_before_discounts - final)):.2f}")
print('='*50)
print('='*50)